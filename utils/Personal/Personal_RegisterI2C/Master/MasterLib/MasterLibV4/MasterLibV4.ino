...
void loop() {
  int8_t reslt;
  reslt = I2C_WriteData(0x55, "012345"); //TRUE: S AA A 30 A 31 A 32 A .. 35 A P
                                      //FALSE: S AB N P        
...
uint8_t I2C_ReadACK(void) {
  ...
  SCL_HIGH;
  uint8_t ACK = SDA_READ; //Nên đọc ở trạng thái ổn định // Sequence 01
  delayMicroseconds(HALF);
  //uint8_t ACK = SDA_READ; //0, 1(LSB) // Sequence 02 STILL OK
