/*------------------------------------------------------------------------------------------------
  -Đây là chương trình delay timer 1 mode CTC
  -Sử dụng so sánh ở thanh ghi đặt trước dữ liệu OCR1A
  -Nếu timer1 chạy được số xung trùng với giá trị đặt trước thì sẽ dừng lại và reset về 0
------------------------------------------------------------------------------------------------*/
...
void t1DelayCTCMode() {
  ...
  OCR1AH = (0x09 << 8) ; //62499 giá trị so sáng\h
  OCR1AL = 0xc3; 
